...
import 'package:chatapp_firebase/controllers/shared_pref.dart';
import 'package:chatapp_firebase/pages/profile_screen.dart';
import 'package:chatapp_firebase/pages/select_location_screen.dart';
          ...
          child: AppBar(
            ...
            title: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    AuthController.instance.user!.displayName ?? "phuocquy",
                    style: const TextStyle(
                      color: Colors.white, // Đổi sang màu mong muốn
                      fontSize: 16, // Thay đổi kích thước chữ nếu cần
                      fontWeight: FontWeight.bold, // Tùy chỉnh thêm kiểu chữ
                    ),
                  ),
                  GestureDetector(
                    onTap: () {
